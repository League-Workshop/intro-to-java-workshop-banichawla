...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adjective = JOptionPane.showInputDialog("Put in an adjective.");
		// Get the user to enter a type of liquid
		String liquid = JOptionPane.showInputDialog("Put in a type of liquid");
		// Get the user to enter a body part
		String bodypart = JOptionPane.showInputDialog(" Put in a body part");
		// Get the user to enter a verb
		String verb = JOptionPane.showInputDialog(" Put in a verb");
		// Get the user to enter a place
		String place = JOptionPane.showInputDialog(" Put in a place");
